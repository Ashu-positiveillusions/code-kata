...
const registerUser = async (req, res) => {
  try {
    ...
    // if (!validator.isValid(userInfo))
    //   return res
    //     .status(400)
    //     .send({ status: false, message: "Please provide User's Info" });

    // // validation of title
    // if (!validator.isValid(userInfo.title))
    //   return res
    //     .status(400)
    ...
    //     .send({
    //       status: false,
    //       message: "Please provide a valid title from [Mr, Mrs, Miss]",
    //     });

    // // validation of name
    // if (!validator.isValid(userInfo.name))
    //   return res
    //     .status(400)
    ...
    //   return res
    //     .status(400)
    //     .send({ status: false, message: "Please provide your Email Id" });
    // userInfo.email = userInfo.email.trim();
    // if (validator1.validate(userInfo.email) == false)
    //   return res
    //     .status(400)
    //     .send({ status: false, msg: "Please input a valid email" });

    // // validation of phone Number
    // if (!validator.isValid(userInfo.phone))
    //   return res
    //     .status(400)
    ...
    //   return res
    //     .status(400)
    //     .send({ status: false, message: "Please enter a valid Phone" });

    //duplicacy check
    // let duplicate = await userModel.find({
    //   $or: [{ email: userInfo.email }, { phone: userInfo.phone }],
    // });
    // if (duplicate.length != 0) {
    //   for (let i = 0; i < duplicate.length; i++) {
    //     if (duplicate[i].email == userInfo.email)
    //       return res
    //         .status(400)
    //         .send({ status: false, message: "Email Id is already in use" });
    //     if (duplicate[i].phone == userInfo.phone)
    //       return res
    //         .status(400)
    ...
    // }
    // password validation
    // if (!validator.isValid(userInfo.password))
    //   return res
    //     .status(400)
    ...
    if (!(userInfo.password.length >= 8 && userInfo.password.length <= 15))
      return res.status(400).send({
        status: false,
        message: "Enter a valid password in range of 8 to 15",
      });
...
const loginUser = async (req, res) => {
  try {
    ...
    if (!email)
      return res
        .status(400)
        .send({ status: false, message: "Please input an email" });
    if (!password)
      return res
        .status(400)
